...
<form id="form1">
	<ul>
		...
		<li>
			<ul>
				<li id="title_7"><label for="txtAddress">住址</label></li>
				<li id="content_7"><
					<input type="text" id="txtAddress" name="Address" maxlength="100" value="<?=$obj->Address; ?>" />	
				</li>
				<li id="title_8"><label for="txtEmail">Email</label></li>
				<li id="content_8"><? echo $obj->Email; ?>
					<input type="email" id="txtEmail" name="Email" maxlength="20" value="<?=$obj->Email; ?>" />	
				</li>
				<li id="title_9"><label for="selectUserType">用户类型</label></li>
				<li id="content_9">
				<select name="UserType" id="selectUserType">
					<option value="0" <? if($obj->UserType=="0")echo "selected";?>>	 
					 管理员
					</option>
					<option value="1" <? if $obj->UserType=="1")echo "selected"; ?>>
					普通用户	
					</option>
				</select>				
				</li>
